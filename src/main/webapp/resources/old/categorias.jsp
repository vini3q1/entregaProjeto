...
<html lang="en">
	<head>
		...
		<!-- bootstrap -->
		<style><%@include file="/WEB-INF/views/bootstrap/css/bootstrap.min.css"%></style>
		<!-- <link href="bootstrap/css/bootstrap.min.css" rel="stylesheet"> -->
		<style><%@include file="/WEB-INF/views/bootstrap/css/bootstrap-responsive.min.css"%></style>      
		<!-- <link href="bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">		 -->
		<style><%@include file="/WEB-INF/views/themes/css/bootstrappage.css"%></style>
		<!-- <link href="themes/css/bootstrappage.css" rel="stylesheet"/> -->
		
		<!-- global styles -->
		<style><%@include file="/WEB-INF/views/themes/css/main.css"%></style>
		<!-- <link href="themes/css/main.css" rel="stylesheet"/> -->
		<style><%@include file="/WEB-INF/views/themes/css/jquery.fancybox.css"%></style>
		<!-- <link href="themes/css/jquery.fancybox.css" rel="stylesheet"/> -->
				
		<!-- scripts -->
		<style><%@include file="/WEB-INF/views/themes/js/jquery-1.7.2.min.js"%></style>
		<!-- <script src="themes/js/jquery-1.7.2.min.js"></script> -->
		<style><%@include file="/WEB-INF/views/bootstrap/js/bootstrap.min.js"%></style>
		<!-- <script src="bootstrap/js/bootstrap.min.js"></script>				 -->
		<style><%@include file="/WEB-INF/views/themes/js/superfish.js"%></style>
		<!-- <script src="themes/js/superfish.js"></script>	 -->
		<style><%@include file="/WEB-INF/views/themes/js/jquery.scrolltotop.js"%></style>
		<!-- <script src="themes/js/jquery.scrolltotop.js"></script> -->
		<style><%@include file="/WEB-INF/views/themes/js/jquery.fancybox.js"%></style>
		<script><%@include file="/WEB-INF/views/js/magicStore.js"%></script>
						...
						<div class="block">	
							<ul class="nav nav-list">
								...
								<c:forEach items="${categorias}" var="categoria">
									<li><a onclick="carrega(${categoria.id})">${categoria.nome}</a></li>
								</c:forEach>
							</ul>
						</div>
